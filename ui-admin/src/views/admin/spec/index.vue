<script setup>
	...
	import {GetList, Delete} from '^/spec'
...
<template>
	<div>
		...
		<el-table
			...
			<el-table-column prop="options" label="可选值" show-overflow-tooltip>
				<template #default="scope">
					<el-tag style="margin-right: 5px;" v-for="item in scope.row.options.split(';')">{{item}}</el-tag>
				</template>

			</el-table-column>
			<el-table-column prop="sortOrder" label="排序" show-overflow-tooltip  width="80"></el-table-column>
